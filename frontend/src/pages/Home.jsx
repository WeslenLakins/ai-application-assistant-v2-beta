	...
	return (
		<>
			<section className='heading'>
				...
				<p>Welcome to the AI Application Assistant v2!</p>
			</section>
			...
			<Link to='/new-question' className='btn btn-reverse btn-block'>
				<FaTicketAlt /> Create New Interview Questions & Answers
			</Link>
			<Link to='/questions' className='btn btn-block'>
				<FaQuestionCircle /> View Interview Questions & Answers
			</Link>
			<Link to='/new-scratch-resume' className='btn btn-reverse btn-block'>
				<FaTicketAlt /> Create New Scratch Resume
			</Link>
			<Link to='/scratch-resumes' className='btn btn-block'>
				<FaQuestionCircle /> View Scratch Resumes
			</Link>
		</>
	);
}
